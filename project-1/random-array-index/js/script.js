...
playBtn.addEventListener('click', () => {
  ...
  const scorePlayer1 = diceRoll(twelveSidedDie);
  const scorePlayer2 = diceRoll(twelveSidedDie);
  ...
  scoreOneElement.innerHTML = scorePlayer1;
  scoreTwoElement.innerHTML = scorePlayer2;
